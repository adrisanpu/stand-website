  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-[#5235ef]/20 blur-[120px]" />
        <div className="absolute bottom-0 right-0 w-[400px] h-[400px] rounded-full bg-[#ff931f]/10 blur-[100px]" />
        <div className="absolute top-0 left-0 w-[300px] h-[300px] rounded-full bg-[#8771ff]/10 blur-[80px]" />
      </div>

      {/* Geometric shapes */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-20 right-12 w-24 h-24 border border-[#5235ef]/30 rounded-2xl rotate-12 opacity-60" />
        <div className="absolute bottom-32 left-10 w-16 h-16 border border-[#ff931f]/30 rounded-xl -rotate-6 opacity-50" />
        <div className="absolute top-1/2 right-1/4 w-8 h-8 bg-[#5235ef]/30 rounded-full opacity-60" />
        <div className="absolute top-1/3 left-1/4 w-4 h-4 bg-[#ff931f]/40 rounded-full opacity-70" />
      </div>

      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#5235ef]/40 bg-[#5235ef]/10 text-sm font-medium text-[#8771ff] mb-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <button
            ...
            className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-[#5235ef] hover:bg-[#ff931f] text-white font-bold text-base transition-colors duration-200 shadow-lg shadow-[#5235ef]/30"
          >
            Ver catálogo
            <ArrowRight size={18} />
          </button>
          <button
            ...
            className="inline-flex items-center gap-2 px-8 py-4 rounded-full border border-white/20 hover:border-[#5235ef] text-white font-semibold text-base transition-colors duration-200"
          >
            Solicitar demo
          </button>
        </div>
